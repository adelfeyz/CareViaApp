...
class UserInfoDialog extends Dialog {
  ...
  UserInfoDialog(this.title, this.userInfoValue, this.onConfirm, {super.key}) {
  ...
  void initData() {
    ...
    _sex_datas.add(FMRadioModel(0, "male", 0, USER.SEX));
    _sex_datas.add(FMRadioModel(1, "female", 1, USER.SEX));

    userInfoValue["function"].value = 0;
    userInfoValue["sex"].value = 0;
  }
                            ...
                            child: TextButton(
                              onPressed: () {
                                if ((userInfoValue["height"].value != 0 &&
                                        ...
                                        userInfoValue["age"].value != 0) ||
                                    userInfoValue["function"] == 0) {
                                  onConfirm(true);
                                } else {
                                  onConfirm(false);
                                }
  ...
  _radio(FMRadioModel model) {
    ...
    return Obx(() => Radio(
        ...
        onChanged: (index) {
          switch (model.type) {
            case USER.FUN:
              userInfoValue["function"].value = model.value;
